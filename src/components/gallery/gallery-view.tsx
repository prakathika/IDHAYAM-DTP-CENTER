...
const galleryItems = [
  {
    src: 'https://source.unsplash.com/random/600x400?document,printing',
  ...
  {
    src: 'https://source.unsplash.com/random/600x400?lamination,machine',
  ...
  {
    src: 'https://source.unsplash.com/random/600x400?military,uniform',
    alt: 'Indian Air Force and Army logos.',
    hint: 'indian armed',
    title: 'Indian Air Force/Army Jobs',
  },
  {
    src: 'https://source.unsplash.com/random/600x400?certificate,document',
  ...
  {
    src: 'https://source.unsplash.com/random/600x400?identity,card',
    alt: 'A new PAN card.',
    hint: 'pan card',
    title: 'New PAN Card 2.0',
  },
  {
    src: 'https://source.unsplash.com/random/600x400?link,connection',
  ...
  {
    src: 'https://source.unsplash.com/random/600x400?bank,linking',
  ...
  {
    src: 'https://source.unsplash.com/random/600x400?job,registration',
  ...
  {
    src: 'https://source.unsplash.com/random/600x400?election,vote',
